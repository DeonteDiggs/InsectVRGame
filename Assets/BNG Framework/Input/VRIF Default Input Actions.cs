// GENERATED AUTOMATICALLY FROM 'Assets/BNG Framework/Input/VRIF Default Input Actions.inputactions'
...
public class @VRIFDefaultInputActions : IInputActionCollection, IDisposable
{
